...
public class WordleGUI extends JPanel{
    ...
    private static final Color BACKGROUND_COLOR = new Color(76, 100, 89, 255);
    private static final Color FOREGROUND_COLOR = Color.WHITE;
    private static final Color BORDER_COLOR = new Color(172, 228, 202, 255);
    ...
    private static final String BACKGROUND_IMAGE_PATH = "src/main/resources/img/peaceBackground.jpg";
